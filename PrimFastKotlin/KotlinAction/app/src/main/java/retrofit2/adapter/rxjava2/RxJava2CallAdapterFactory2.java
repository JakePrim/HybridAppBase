...
public final class RxJava2CallAdapterFactory2 extends CallAdapter.Factory {
    ...
    public static RxJava2CallAdapterFactory2 createWithScheduler(Scheduler scheduler) {
        ...
        return new RxJava2CallAdapterFactory2(scheduler, null, false);
    }

    public static RxJava2CallAdapterFactory2 createWithScheduler(Scheduler netScheduler, Scheduler mainScheduler) {
        if (netScheduler == null) throw new NullPointerException("netScheduler == null");
        if (mainScheduler == null) throw new NullPointerException("mainScheduler == null");
        return new RxJava2CallAdapterFactory2(netScheduler, mainScheduler, false);
    }
    ...
    private RxJava2CallAdapterFactory2(Scheduler netScheduler, @Nullable Scheduler mainScheduler, boolean isAsync) {
    ...
    public CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
        ...
        if (rawType == Completable.class) {
            ...
            return new RxJava2CallAdapter2(Void.class, netScheduler, mainScheduler, isAsync, false, true, false, false, false,
                    false, true);
        }
        ...
        return new RxJava2CallAdapter2(responseType, netScheduler, mainScheduler, isAsync, isResult, isBody, isPaging, isFlowable,
