# PrimFast
 PrimFast 是自己系统性学习技术记录的开源项目,也是我自己的未来发展方向:大前端全栈为主要方向.
...
| 文章标题 | 状态 | 原创/转载 |
| --- | --- | --- |
| [动态换肤原理与基础换肤实现](https://jakeprim.cn/2019/09/17/skin-1/) | [已完成] | 原创 |
| [动态换肤扩展-支持自定义view](https://jakeprim.cn/2019/09/17/skin-2/) | [已完成] | 原创 |

####  IOC 注入式框架原理及实现

实现demo地址:https://github.com/JakePrim/IOCCore

| 文章标题 | 状态 | 原创/转载 |
| --- | --- | --- |
| [揭秘IOC架构](https://jakeprim.cn/2019/09/25/ioc/) | [已完成] | 原创 |
...
实现demo地址:https://github.com/JakePrim/ImageLoaderPrinciple
...
| 文章标题 | 状态 | 原创/转载 |
| --- | --- | --- |
| [从0开始音视频开发:C数据类型和内存模型](https://jakeprim.cn/passages/2019-10-28-yin-shi-pin-1/) | [已完成] | 原创 |
...
| --- | --- | --- |
| [ffmpeg命令详解]() | [敬请期待] | 原创 |
| [ffmpeg播放器1-直播流信息获取]() | [敬请期待] | 原创 |
| [ffmpeg播放器2-视频解码与原生绘制]() | [敬请期待] | 原创 |
| [ffmpeg播放器3-音频解码与opensl es播放]() | [敬请期待] | 原创 |
| [ffmpeg播放器4-音视频同步]() | [敬请期待] | 原创 |
| [ffmpeg播放器5-停止与释放]() | [敬请期待] | 原创 |
